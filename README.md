...
### Validating a Commit Range

To validate commits between two git references, use `--base` and `--head`:

```bash
gitlance --base main --head HEAD
```

Any valid git reference works: branches, tags, SHAs, or symbolic refs like
`HEAD~3`.
